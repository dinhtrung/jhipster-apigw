...
To build the final jar and optimize the apigw application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v7.3.1/microservices-architecture/#consul
